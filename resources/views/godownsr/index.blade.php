<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            {{-- Create New Customer --}}
            <a class="text-sm text-green-500 hover:text-gray-900" href="{{route('godownsr.create')}}">
                {{-- Add Icon --}}
            ...
            <span> | </span>
            <button class="text-sm text-blue-300" onclick="setStatus(2)">Sale Return History</button>
        </h2>
    </x-slot>
...
<script>
    ...
    const getMaster = @json(route('godownsr.master'));
    const getDetails = @json(route('godownsr.details'));
    let table;
    let searchValue = "";
    ...
    table = new Tabulator("#tableData", {
      ...
      //      Master Data
            ...
            {title: "Sale Return Id",field: "id",visible:false},
            // {title: "G.P No",field: "gpno"},
            {title: "Customer",field: "customer.title"},
            {title: "D.C No",field: "purinvsno"},
            {title: "D.C Date",field: "contract_date"},
            // {title: "Purchase Invoice Date",field: "purinvsdt"},
            {title: "Sale.Ret.Invs.ID",field: "contract_id"},
