<x-app-layout>
    ...
    <x-slot name="header">
        <div style="font-size: 3rem;font-weight: bold;color:brown;border:blue">
            Delete Record Information for Purchase Return
        </div>
    </x-slot>
                ...
                <div class="px-6 py-2">
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <div class="grid grid-cols-12 gap-2 py-2 items-center">
                            ...
                            <x-input-date title="Purchase Invoice Date" name="invoice_date" id="invoice_date" disabled class="col-span-2"  value="{{ $purchasereturn->prinvdate }}" disabled  />
                            <x-input-text title="Purchase Invoice No" name="invoiceno" id="invoiceno" disabled class="col-span-2" value="{{ $purchasereturn->prinvno }}" disabled  />
                        </div>
                        <div class="grid grid-cols-12 gap-1 py-2 items-center">
                            <x-input-date title="Purchase Return Date" id="prdate" name="prdate" value="{{ $purchasereturn->prdate }}" disabled class="col-span-2" />
                            <x-input-text title="Purchase Return No" name="prno" id="prno" value="{{ $purchasereturn->prno }}" disabled     />

                            <x-input-text title="" name="prid" id="prid" value="{{ $purchasereturn->id }}" disabled     />
                                <label for="">
                                    Descripiton <span class="text-red-500 font-semibold"></span>
                                </label>
                                <textarea name="retdescription" id="retdescription" disabled cols="30" rows="2" maxlength="150" required class="rounded"> {{ $purchasereturn->retdescription }} </textarea>
                                <x-input-text title="prgp" name="prgp" id="prgp" value="{{ $prgp }}" disabled     />
...
function validateForm()
{
    var sid = document.getElementById("supplier_id");
        ...
        var prgp = document.getElementById("prgp");
        ...
        if(prgp.value == prid.value  )
        {
            showSnackbar("First of all Delete Data From Godown Return of this Invoice");
            // dcno.focus();
            return;
        }
    ...
    fetch(@json(route('purchasereturn.del')),{
