                ...
                <div class="px-6 py-2" >
                    ...
                    <div class="flex gap-8">
                        ...
                        <div class="flex flex-col justify-start items-center">
                            ...
                            @csrf
                                <x-label for="unitname" :value="__('Name')"/>
                                <x-input id="unitname" class="bg-indigo-100" type="text" name="unitname" :value="old('unitname')"  required minlength="2"/>
                        ...
                        <div class="ml-4 pt-1 border border-slate-300 w-full p-2">
                            <span class="text-indigo-500 border-b">Existing Units</span>
