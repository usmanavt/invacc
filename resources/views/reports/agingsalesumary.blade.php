...
{{-- https://stackoverflow.com/questions/3341485/how-to-make-a-html-page-in-a4-paper-size-pages?answertab=votes#tab-top --}}
    ...
    <table>
        <tbody>
            ...
            <tr>
                <td  style="text-align: center;">
                    <span style="font-size:1.5rem">CUSTOMER AGEING SUMMARY </span>
                </td>
            </tr>
    ...
    <table class="column-headers">
        <thead>
            ...
            <tr>
                ...
                <td colspan="1" width="20%" style="text-align:center;font-weight: bold;border-right: 1px solid lightgray;">Customer</td>
