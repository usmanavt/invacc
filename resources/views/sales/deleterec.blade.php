<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <div style="font-size: 3rem;font-weight: bold;color:brown;border:blue">
            Delete Record Information For Sale W P.O
        </div>
    </x-slot>
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <div class="grid grid-cols-12 gap-2 py-2 items-center">
                            ...
                            <x-input-text title="P.O Seq.#" name="poseqno" id="poseqno" value="{{ $customerorder->poseqno }}"    required   /> --}}
                                ...
                                <x-input-text title="G.Pass No" name="gpno" id="gpno" value="{{ $saleinvoices->gpno }}" disabled    required   />


                        </div>
                        <div class="grid grid-cols-12 gap-1 py-2 items-center">
                            <x-input-date title="Deilivery Date" id="deliverydt" name="deliverydt" disabled class="col-span-2" value="{{ $saleinvoices->saldate->format('Y-m-d') }}" />
                            <x-input-text title="DC No" name="dcno" id="dcno" value="{{ $saleinvoices->dcno }}"     disabled   />
                            <x-input-text title="Bill No" name="billno" id="billno" value="{{ $saleinvoices->billno }}"     disabled   />
                                <label for="">
                                    Descripiton <span class="text-red-500 font-semibold"></span>
                                </label>
                                <textarea name="saldescription" id="saldescription" cols="30" rows="2" maxlength="150" disabled class="rounded"> {{ $saleinvoices->saldescription }} </textarea>
                        ...
                        <fieldset class="border px-4 py-2 rounded">
                            ...
                            <div class="grid grid-cols-12 gap-2 py-2 items-center">
                                <x-input-numeric title="Sale Tax(%)" name="saletaxper" class="col-span-2" value="{{ $saleinvoices->saletaxper }}" disabled  onblur="tnetamount()"  />
                                <x-input-numeric title="Sale Tax(Rs)" name="saletaxamt" class="col-span-2" value="{{ $saleinvoices->saletaxamt }}" disabled    />
                                <x-input-numeric title="Cartage" name="cartage" class="col-span-2" value="{{ $saleinvoices->cartage }}"  disabled  onblur="tnetamount()"  />
