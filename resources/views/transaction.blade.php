            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 bg-white border-b border-gray-200">
                    ...
                    <div class="flex flex-wrap items-center gap-2 justify-center">
                        ...
                        <a class="basis-0 md:basis-1/4 bg-blue-500 hover:bg-blue-700 text-white px-2 py-4 rounded-lg shadow-lg"  href="{{ route('contracts.index') }}" >
                            <i class="fa-solid fa-truck-field fa-2xl"></i> Contracts
                        </a>

                        <a  class="basis-0 md:basis-1/4 bg-blue-500 hover:bg-blue-700 text-white px-2 py-4 rounded-lg shadow-lg" href= "" >
