                ...
                <div class="px-6 py-2" >
                    ...
                    <div class="flex gap-8">
                        ...
                        <div class="flex flex-col justify-start items-center">
                            ...
                            @csrf
                                <x-label for="brandname" :value="__('Name')"/>
                                <x-input id="brandname" class="bg-indigo-100" type="text" name="brandname" :value="old('brandname')"  required minlength="2"/>
                                @if($errors->has('brandname'))<div class="text-red-500 text-xs">{{ $errors->first('brandname') }}</div>@endif
                        ...
                        <div class="ml-4 pt-1 border border-slate-300 w-full p-2">
                            <span class="text-indigo-500 border-b">Existing Brands</span>
