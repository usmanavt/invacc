<x-app-layout>
    ...
    <x-slot name="header">
        <div style="font-size: 3rem;font-weight: bold;color:brown;border:blue">
            Delete Record Information for Purchase Order
        </div>
    </x-slot>
    <div class="py-6">
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <fieldset class="border px-4 py-2 rounded">
                            ...
                            <div class="grid grid-cols-12 gap-2 py-2 items-center">
                                ...
                                <x-input-numeric title="Reserve No" name="rsrvpo" id='rsrvpo' value="{{ $rsrvpo }}" disabled />
                            </div>
...
function validateForm()
{
    ...
    if(customer_id.value < 0)
        ...
        if(sale_invoice_id.value == rsrvpo.value)
        {
            showSnackbar("P.O No already used in sale invoice");
            saldate.focus();
            return;
        }
        if(poseqno.value == 0)
    ...
    fetch(@json(route('customerorder.del')),{
