...
{{-- https://stackoverflow.com/questions/3341485/how-to-make-a-html-page-in-a4-paper-size-pages?answertab=votes#tab-top --}}
    ...
    <table>
        <tbody>
            ...
            <tr>
                <td  style="text-align: center;">
                    <span style="font-size:2rem;font-weight: bold">BALANCE SHEET </span>
                </td>
            </tr>
    ...
    <table class="column-headers">
        <thead>
            <tr>
                ...
                <th class="column-headers" width="28%">Title1</th>
                <th class="column-headers" width="13%">Amount1</th>
                <th class="column-headers" width="13%">gape1</th>
                <th class="column-headers" width="28%">Title2</th>
                <th class="column-headers" width="13%">Amount2</th>
    ...
    <table class="data" cellspacing="0">
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: left"; width="28%">{{ $data[$i]->gape1 }} </td>
