<x-app-layout>
    ...
    <x-slot name="header">
        <div style="font-size: 2rem;font-weight: bold;color:brown;border:blue">
            Delete Record Information For Purchase Return Godown GatePasse
        </div>
    </x-slot>
    <div class="py-6">
                        ...
                        <div class="grid grid-cols-12 gap-2 py-2 items-center">
                            ...
                            <select  autocomplete="on" class="col-span-2" name="supplier_id" id="supplier_id" disabled required>
                                @foreach($supplier as $supplier)
                                    @if ($supplier->id == $godownpr->supplier_id)
                            ...
                            <x-input-numeric title="" name="purid" id="purid" value="{{ $purchasing->id }}" hidden  /> --}}
                                ...
                                <x-input-text title="" name="contract_id" id="contract_id" value="{{ $godownpr->contract_id }}" hidden   disabled  />
                                <x-input-text title="" name="cominvid" id="cominvid" value="{{ $godownpr->cominvid }}" hidden disabled  />
                                <x-input-date title="Purchase.Invoice Date" id="contract_date" name="contract_date" value="{{ $godownpr->contract_date }}" class="col-span-1"  disabled />
                                <x-input-text title="Purchase.Invice#" id="purinvsno" name="purinvsno" value="{{ $godownpr->purinvsno }}"  disabled />

                                <x-input-text title="" id="tranid" name="tranid" value="{{ $godownpr->id }}" hidden disabled />

                        </div>
                        <div class="grid grid-cols-12 gap-1 py-2 items-center">
                            <x-input-text title="Pur.Ret.Inv Date/#" name="retstatus" id="retstatus" value="{{ $godownpr->contract_id }} /  {{ $godownpr->contract_date }} "   class="col-span-2"   disabled  />
                            <x-input-date title="GatePass Date" id="purdate" name="purdate" value="{{ $godownpr->gpdate }}"  />
                            <x-input-text title="GatePass #" name="purseqid" id="purseqid" value="{{ $godownpr->gpno }}"  disabled />
