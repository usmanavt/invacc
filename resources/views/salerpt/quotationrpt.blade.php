        ...
        <thead >
            <tr>
                {{-- <td  style="text-align: center font-size:0.5rem;font-weight: bold"> --}}
                    ...
                    <th class="" width="33%">Material Name</th>
                    <th class="" width="6%">Unit</th>
                    <th class="" width="12%">Brand</th>
    ...
    <table class="data" cellspacing="0">
        <tbody>
            ...
            <tr>
                ...
                <td class="" width="33%">{{ $data[$i]->matname }} </td>
                <td style="text-align:center" width="6%">{{ $data[$i]->UOM }} </td>
                <td style="text-align:left" width="12%">{{ $data[$i]->mybrand }} </td>
