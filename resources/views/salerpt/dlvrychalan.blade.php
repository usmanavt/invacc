...
.            </tr>
    ...
    <table>
        <tbody>
            ...
            <tr>
                <td  style="text-align: center;">
                    <span style="font-size:3rem;font-weight: bold">Delivery Challan</span>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="data" cellspacing="0">
        <tbody>
            ...
            <tr>
                ...
                <td class="" width="6%">{{ $data[$i]->unit }} </td>
                <td class="" width="10%">{{ number_format($data[$i]->qty,0) }} </td>
                {{-- <td class="" width="10%">{{ number_format($data[$i]->price,1) }} </td>
                <td class="" width="12%">{{ number_format($data[$i]->value,0) }} </td> --}}
            </tr>
            @endfor
            <tr>
                <td colspan="5" width="100%" style="text-align: right;border-bottom: 1px solid lightgray;"></td>
