...
@push('scripts')
    <script>
        ...
        const getDetails = @json($clearance->clearancePendingDetails);
    ...
    <script>
        var calculate = function()
        {
            ...
            data.forEach(e => {
                ...
                if(e.pcs > e.pcs_pending)
                {
                    showSnackbar("Rcv Pcs cannot be more then PCS","error");
            ...
            columns:[
                ...
                {title:"brand_id",     field:"brand_id",visible:false},
                {
                    ...
                    columns:[
                        ...
                        {   title:"Pcs Rcv",headerHozAlign :'center',
                            responsive:0,
                            field:"pcs",
                            editor:"number",
                            headerVertical:true,
        ...
        function validateForm()
        {
            ...
            var data = {
                'commercal_invoice_id':@json($clearance->commercial_invoice_id),
