...
.            </tr>
    ...
    <table class="column-headers1">
        <tbody>
            <tr> <td  >IMPORT PURCHASE INVOICE </td>  </tr>
        ...
        <thead >
            ...
            <tr>
                {{-- <td  style="text-align: center font-size:0.5rem;font-weight: bold"> --}}
                    ...
                    <th class="column-headers" width="24%">MATERIAL NAME</th>
                    <th class="column-headers" width="10%">SIZE</th>
                    {{-- For Supplier --}}
                    <th class="column-headers" width="7%">WEIGHT</th>
                    <th class="column-headers" width="7%">PCS</th>
                    <th class="column-headers" width="4%">LENGTH</th>
                    <th class="column-headers" width="7%">FEET</th>

                    <th class="column-headers" width="9%">PER/PCS</th>
                    <th class="column-headers" width="9%">PER/KG</th>
                    <th class="column-headers" width="9%">PER/FEET</th>
    ...
    <table class="data" cellspacing="0">
        ...
        @endif
            ...
            <tr>
                ...
                {{ $owt += $data[$i]->supwt }};{{ $opcs += $data[$i]->pcs }};{{ $gtlc += $data[$i]->totallccostwexp }};{{ $ofeet += $data[$i]->qtyinfeet }}
                ...
                <td style="text-align:left; font-size: 0.8rem" width="24%">{{ $data[$i]->matname}} </td>
                <td style="text-align:center; font-size: 0.8rem" width="10%">{{ $data[$i]->size}} </td>


                <td style="text-align:right; font-size: 0.8rem" width="7%">{{ number_format($data[$i]->supwt,0) }} </td>
                <td style="text-align:right; font-size: 0.8rem" width="7%">{{ number_format($data[$i]->pcs,0) }} </td>
                <td style="text-align:center; font-size: 0.8rem" width="4%">{{ number_format($data[$i]->itmlen,0) }} </td>
                <td style="text-align:right; font-size: 0.8rem" width="7%">{{ number_format($data[$i]->qtyinfeet,0) }} </td>


                <td style="text-align:right; font-size: 0.8rem" width="9%">{{ number_format($data[$i]->perpc,1) }} </td>
                <td style="text-align:right; font-size: 0.8rem" width="9%">{{ number_format($data[$i]->perkg,1) }} </td>
                <td style="text-align:right; font-size: 0.8rem" width="9%">{{ number_format($data[$i]->perft,1) }} </td>
