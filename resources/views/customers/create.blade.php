    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-2 lg:px-4">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                {{-- Create Form --}}
                <div class="px-12 py-2 " onload="getfocustxt()";>
                        ...
                        @csrf
                            <div class="flex flex-row justify-start space-x-12 items-center">
                                ...
                                <div>
                                    ...
                                    <x-input id="sname" class="block mt-2 bg-slate-200 w-96" type="cname" name="cname" :value="old('cname')"  />
                                </div>
                                <div>
                                    <x-label for="cnname" :value="__('Knick Name')" />
                                    <x-input id="cnname" class="block mt-2 bg-slate-200" type="cnname" name="cnname" :value="old('cnname')"  />
                                </div>

                                <div>
                                    <x-label for="cphoneoff" :value="__('Tel.(Office)')" />
                                    <x-input id="cphoneoff" class="block mt-2 bg-slate-200" type="cphoneoff" name="cphoneoff" :value="old('cphoneoff')"  />
                                </div>
                                <div>
                                    <x-label for="cphoneres" :value="__('Tel.(Residence)')" />
                                    <x-input id="cphoneres" class="block mt-2 bg-slate-200" type="cphoneres" name="cphoneres" :value="old('cphoneres')"  />
                                </div>
                            </div>
                            ...
                            <div class="flex flex-row justify-between items-center mt-6">
                                ...
                                <div>
                                    ...
                                    <x-input id="cfax" class="block mt-1 bg-slate-200 w-10" type="cfax" name="cfax" :value="old('cfax')"  />
                                </div>
                            <div>
                                    <x-label for="cemail" :value="__('Email')" />
                                    <x-input id="cemail" class="block mt-1 bg-slate-200" type="cemail" name="cemail" :value="old('cemail')"   />
                                </div>

                                <div>
                                    <x-label for="ntnno" :value="__('NTN No')" />
                                    <x-input id="ntnno" class="block mt-1 bg-slate-200" type="ntnno" name="ntnno" :value="old('ntnno')"  />
                                </div>
                                <div>
                                    <x-label for="staxno" :value="__('Sale Tax Registration No')" />
                                    <x-input id="staxno" class="block mt-1 bg-slate-200" type="staxno" name="staxno" :value="old('staxno')"  />
                                </div>
                                <div>
                                    <x-label for="obalance" :value="__('O/Balance')" />
                                    <x-input id="obalance" class="block mt-1 bg-slate-200" type="obalance" name="obalance" :value="old('obalance')"  />
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    {{-- <div class="flex justify-center">
                                        <div class="mb-3 xl:w-96"> --}}
                                          ...
                                          <textarea  class=" form-control block w-full px-3 py-1.5 text-base font-normal  text-gray-700  bg-white bg-clip-padding  border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="cpaddress" id="cpaddress" rows="3" placeholder=""></textarea>
                                        {{-- </div>
                                      </div> --}}
                            ...
                            <div class="flex flex-row justify-start items-start mt-2">
                                ...
                                <div class="form-check">
                                  ...
                                  <div class="form-check">
                                    <input class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" value="Stop" type="radio" name="cstatus" id="flexRadioDefault2" >
                            ...
                            <div class="mt-2">
                                <div>
                                    ...
                                    <select required name="cop" id="cop" class="block mt-1 bg-slate-200 text-sm rounded-lg">
                                        ...
                                        @foreach($co as $list)
                                            <option value="{{$list->coid}}" >  {{$list->coname}}  </option>
                                        @endforeach
                                    </select>
                                </div>
