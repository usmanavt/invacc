                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex flex-col justify-start items-center border rounded-md px-2">
                        <form action="{{ route('categories.store') }}" method="post" >
                            ...
                            <x-input id="nick" type="text" name="nick"  required minlength="3" :value="old('title')"/>
...
<script>
    ...
    const getMaster = @json(route('categories.master'));
    let table;
    let searchValue = "";
    //  Table Filter
    ...
    table = new Tabulator("#tableData", {
        ...
        columns:[
            ...
            {title:"Nick", field:"nick", responsive:0},
