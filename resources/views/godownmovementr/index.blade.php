<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Goods Movement GatePass
            {{-- Create New Customer --}}
            <a class="text-sm text-green-500 hover:text-gray-900" href="{{route('godownmovementr.create')}}">
                {{-- Add Icon --}}
            ...
            <span> | </span>
            <button class="text-sm text-blue-300" onclick="setStatus(2)">Goods Movement History</button>
        </h2>
    </x-slot>
...
<script>
    ...
    const getMaster = @json(route('godownmovementr.getindex'));
    ...
    table = new Tabulator("#tableData", {
      ...
      //      Master Data
            ...
            {
            title:'Total Goods Transfered', headerHozAlign:"center",
            columns:[
            ...
            // {
            // title:'Pending Against Godown Input', headerHozAlign:"center",
            // columns:[

            // {title: "Weight",field: "bqtywt"},
            // {title: "Pcs",field: "bqtypcs"},
            // {title: "Feet",field: "bqtyfeet"},
            // ]},
