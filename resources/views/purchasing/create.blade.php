                    ...
                    <div class="grid">
                        ...
                        <fieldset class="border px-4 py-2 rounded">
                            ...
                            <div class="grid grid-cols-12 gap-1 py-2 items-center">
                                ...
                                <x-input-text title="Contract No" name="contract_id" id="contract_id" req required class="col-span-2" disabled  />
                                <x-input-date title="Contract Date" id="contract_date" name="contract_date" req required class="col-span-2" disabled />
...
@push('scripts')
    <script>
        ...
        const getDetails = @json(route('contfrpur.dtl'));
                ...
                dynamicTable.addData([
                    {
                        ...
                        purpcstot:obj.totpcs,purwttot:obj.gdswt,purfeettot:obj.totpcs * 20,
...
var updateValues = (cell) => {
    ...
    var totalVal = function(values, data, calcParams){
        ...
        'supplier_id': supplier_id,'contract_id':contract_id.value,'contract_date':contract_date.value,'purseqid':purseqid.value,
            ...
            // All Ok - Proceed
            fetch(@json(route('purchasing.store')),{
