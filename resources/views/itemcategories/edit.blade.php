        ...
        <div class="max-w-7xl mx-auto sm:px-2 lg:px-4">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="px-12 py-2" >
                    ...
                    <form action="{{ url('/itemcategory/update')."/".$itemcategory->id }} " method="post" >
                        @csrf
                                <div class="flex flex-row justify-start space-x-12 items-center">
                                    <x-label for="Iname0" :value="__('Item Category')" />
                                    <x-input id="iname0" class="block mt-2 bg-slate-200 w-96" type="iname0" name="iname0" value="{{$itemcategory->iname0}}"  />
                                </div>
                                <div class="flex flex-row justify-start space-x-12 items-center">
                                    <x-label for="inname0" :value="__('Knick Name')" />
                                    <x-input id="inname0" class="block mt-2 bg-slate-200" type="inname0" name="inname0" value="{{$itemcategory->inname0}}"  />
                                </div>
