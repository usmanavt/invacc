                        ...
                        <div class="flex flex-col justify-start items-center">
                            ...
                            @method('PUT')
                                ...
                                <fieldset class="border rounded my-2 py-2 px-2">
                                    ...
                                    <x-input id="password" class="bg-indigo-100" type="password" name="password" value=""/>
                                    @if($errors->has('password'))<div class="text-red-500 text-xs">{{ $errors->first('password') }}</div>@endif

                                    <x-label for="password_confirmation" value="Confirm Password"/>
                                    <x-input id="password_confirmation" class="bg-indigo-100" type="password" name="password_confirmation" value=""/>
