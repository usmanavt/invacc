...
.
                        ...
                        <div class="flex flex-col-12">
                            ...
                            {{-- <div class="flex flex-col"> --}}
                                ...
                                <textarea name="repcustname" id="repcustname" cols="20" rows="2" maxlength="100" placeholder="repcustname" required class="rounded">
                                    {{$mycname}}
                                </textarea>
                                ...
                                <textarea name="repcustadrs" id="repcustadrs" cols="30" rows="2" maxlength="150" required class="rounded">
                                    Steam Pipes, Pipe Fitting, Flanges Valves, S.S Pipes & Tubes Plot # 8
                                    Near Allah Malik Godown Shershah Kabari Bazar,Phone : 021-32588781, 021-32574285 ,
                                    Fax : 021-32588782
                                </textarea> --}}
