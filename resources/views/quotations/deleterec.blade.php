<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <div style="font-size: 3rem;font-weight: bold;color:brown;border:blue">
            Delete Record Information For Price Quotation
        </div>
    </x-slot>
                ...
                <div class="px-6 py-2">
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <div class="grid grid-cols-12 gap-2 py-2 items-center">
                            ...
                            <input type="date"  class="col-span-2"  id="saldate" name="saldate" disabled value="{{ $quotation->saldate->format('Y-m-d') }}" required>

                            <label for="valdate">Valid Date<x-req /></label>
                            <input type="date"  class="col-span-2"  id="valdate" name="valdate" disabled value="{{ $quotation->valdate->format('Y-m-d') }}" required>

                            <label for="qutno">Quotation No <x-req /></label>
                            <input type="text" class="col-span-2" id="qutno" name="qutno" disabled value="{{ $quotation->qutno }}"    placeholder="qutno" required>

                            <label for="prno">P.R No#<x-req /></label>
                            <input type="text" class="col-span-2" id="prno" name="prno" disabled value="{{ $quotation->prno }}"  placeholder="prno" required>

                            <label for="">
                                Cash Customer Name
                                {{-- <span class="text-red-500 font-semibold">(*)</span> --}}
                            </label>
                            <textarea name="cashcustomer" id="cashcustomer" cols="30" disabled  rows="1" maxlength="100"   required class="rounded">
                            ...
                            <textarea name="cashcustadrs" id="cashcustadrs" cols="50" rows="1" maxlength="150" disabled required class="rounded">
                        ...
                        <fieldset class="border px-4 py-2 rounded">
                            ...
                            <div class="grid grid-cols-12 gap-2 py-2 items-center">
                                <x-input-numeric title="Discou(%)" name="discntper" id="discntper" value="{{ $quotation->discntper }}" disabled    />
                                <x-input-numeric title="Discount(Amount)" name="discntamt" id="discntamt" value="{{ $quotation->discntamt }}" disabled    />
                            ...
                            <div class="grid grid-cols-12 gap-2 py-2 items-center">
                                <x-input-numeric title="Sale Tax(%)" name="saletaxper" value="{{ $quotation->saletaxper }}" disabled  onblur="tnetamount()"  />
                                <x-input-numeric title="Sale Tax(Rs)" name="saletaxamt" value="{{ $quotation->saletaxamt }}" disabled    />
                                <x-input-numeric title="Cartage" name="cartage" value="{{ $quotation->cartage }}"  disabled  onblur="tnetamount()"  />
                            ...
                            <div>
                                ...
                                <label for="">
                                   <span style="color: brown;font-weight: bold"> Quotation  Close </span> <span class="text-red-500 font-semibold  "> </span>
                                    ...
                                    <x-input-numeric title="rsrvpo" name="rsrvpo" id="rsrvpo" value="{{ $rsrvpo }}"   />
                            </div>
...
function validateForm()
{
    var sid = document.getElementById("customer_id");
        ...
        var rsrvpo= document.getElementById("rsrvpo");



    // Required
    if(rsrvpo.value == sale_invoice_id.value)
        {
            showSnackbar("Quotation Alreday Used In Purhcase Order");
            // customer_id.focus();
            return;
        }
    ...
    // All Ok - Proceed
    fetch(@json(route('quotations.del')),{
