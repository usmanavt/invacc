                            ...
                            <table class="min-w-full divided-y divide-gray-500">
								...
								<tbody class="bg-white divide-y divide-gray-200">
									@foreach($suppliers as $supplier)
										<tr class="border-b">
											<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{$supplier->title}}</td>
											...
											<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{$supplier->ntn}}</td>
											<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{$supplier->status == 1 ? 'Active':'Deactive'}}</td>
											<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{$supplier->source->title}}</td>
