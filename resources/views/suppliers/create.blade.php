                        ...
                        @csrf
                            <div class="flex flex-row justify-start space-x-12 items-center">
                                ...
                                <div>
                                    ...
                                    <x-input id="sname" class="block mt-2 bg-slate-200 w-96" type="sname" name="sname" :value="old('sname')"  />
                                </div>
                                <div>
                                    <x-label for="snname" :value="__('Knick Name')" />
                                    <x-input id="snname" class="block mt-2 bg-slate-200" type="snname" name="snname" :value="old('snname')"  />
                                </div>

                                <div>
                                    <x-label for="sphoneoff" :value="__('Tel.(Office)')" />
                                    <x-input id="sphoneoff" class="block mt-2 bg-slate-200" type="sphoneoff" name="sphoneoff" :value="old('sphoneoff')"  />
                                </div>
                                <div>
                                    <x-label for="sphoneres" :value="__('Tel.(Residence)')" />
                                    <x-input id="sphoneres" class="block mt-2 bg-slate-200" type="sphoneres" name="sphoneres" :value="old('sphoneres')"  />
                                </div>
                            </div>
                            ...
                            <div class="flex flex-row justify-between items-center mt-6">
                                ...
                                <div>
                                    ...
                                    <x-input id="sfax" class="block mt-1 bg-slate-200 w-10" type="sfax" name="sfax" :value="old('sfax')"  />
                                </div>
                            <div>
                                    <x-label for="semail" :value="__('Email')" />
                                    <x-input id="semail" class="block mt-1 bg-slate-200" type="semail" name="semail" :value="old('semail')"   />
                                </div>
                                ...
                                <div>
                                    ...
                                    {{-- <div class="flex justify-center">
                                        <div class="mb-3 xl:w-96"> --}}
                                          ...
                                          <textarea  class=" form-control block w-full px-3 py-1.5 text-base font-normal  text-gray-700  bg-white bg-clip-padding  border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="spaddress" id="spaddress" rows="3" placeholder=""></textarea>
                                        {{-- </div>
                                      </div> --}}
