<x-app-layout>
    ...
    <x-slot name="header">
        <div style="font-size: 3rem;font-weight: bold;color:brown;border:blue">
            Delete Record Information for Import Purchase
        </div>
    </x-slot>
                    ...
                    <div class="grid">
                        ...
                        <fieldset class="border px-4 py-2 rounded">
                            ...
                            <div class="grid grid-cols-12 gap-2 py-2 items-center">
                                ...
                                <x-input-text title="Invoice #" name="invoiceno" value="{{ $i->invoiceno }}" disabled/>
                                {{-- <x-input-text title="Challan #" name="challanno" value="{{ $i->challanno }}" req required class=""/> --}}

                                <x-input-numeric title="Duty.Conv.Rate" name="conversionrate" value="{{ $i->conversionrate }}" req disabled/>
                                <x-input-numeric title="Supp.Conv.Rate" name="sconversionrate" value="{{ $i->sconversionrate }}"  disabled/>
                                <x-input-numeric title="Insurance" name="insurance"  value="{{ $i->insurance }}" disabled/>
                            ...
                            <div class="grid grid-cols-12 gap-2 py-2 items-center">
                                ...
                                <x-input-text title="Machine #" name="machineno" value="{{ $i->machineno }}" disabled class="col-span-2"/>
                                    ...
                                    <select autocomplete="on" required name="packingid" id ="packingid" disabled  >
                                 ...
                                 <x-input-text title="Nos Of Packages" name="packingwt" value="{{ $i->packingwt }}" disabled />
                        ...
                        <fieldset class="border px-4 py-2 rounded">
                            ...
                            <div class="grid grid-cols-12 gap-2 py-2 items-center">
                                ...
                                <x-input-numeric title="BANK CHARGES" name="bankcharges" value="{{ $i->bankcharges }}"  disabled  onblur="calculateBankCharges()"/>
                                <x-input-numeric title="Cust Coll" name="collofcustom" value="{{ $i->collofcustom }}"  disabled  onblur="calculateBankCharges()"/>
                                <x-input-numeric title="Ex Tax of" name="exataxoffie" value="{{ $i->exataxoffie }}"  disabled  onblur="calculateBankCharges()"/>
                                <x-input-numeric title="Ship Doc Chg" name="lngnshipdochrgs" value="{{ $i->lngnshipdochrgs }}"  disabled  onblur="calculateBankCharges()"/>
                                <x-input-numeric title="Lcl Cartage" name="localcartage" value="{{ $i->localcartage }}"  disabled  onblur="calculateBankCharges()"/>
                                <x-input-numeric title="Misc Exp Lunch" name="miscexplunchetc" value="{{ $i->miscexplunchetc }}"  disabled  onblur="calculateBankCharges()"/>
                                <x-input-numeric title="Custom Sepoy" name="customsepoy" value="{{ $i->customsepoy }}"  disabled  onblur="calculateBankCharges()"/>
                                <x-input-numeric title="Weigh Bridge" name="weighbridge" value="{{ $i->weighbridge }}"  disabled  onblur="calculateBankCharges()"/>
                                <x-input-numeric title="Misc Exp" name="miscexpenses" value="{{ $i->miscexpenses }}"  disabled  onblur="calculateBankCharges()"/>
                                <x-input-numeric title="Agency Chgs" name="agencychrgs" value="{{ $i->agencychrgs }}"  disabled  onblur="calculateBankCharges()"/>
                                <x-input-numeric title="Other Chgs($)" name="otherchrgs" value="{{ $i->otherchrgs }}"  disabled  onblur="calculateBankCharges()"/>
                        ...
                        <div class="flex flex-row px-4 py-2 items-center">
                            ...
                            <textarea name="comdescription" id="comdescription" cols="30" rows="2" maxlength="150" disabled class="rounded">  {{ $i->comdescription }} </textarea>
...
@push('scripts')
    <script>
        ...
        /// before edit
                ...
                //   var goods_received =  ( parseFloat(dtyamtinpkrtotal) / parseFloat(totwt) ) * parseFloat(e.dutygdswt)
           ...
           var totwt = 0
            data.forEach(e => {
             ...
             var total =  ( parseFloat(sumoftotdty)/parseFloat(totwt) ) * parseFloat(gdswt)

             var invlvlchrgs = ( parseFloat(banktotal.value)/parseFloat(totwt) ) * parseFloat(gdswt)

            //  var invlvlchrgs =(banktotal.value * itmratio / 100)
             var totallccostwexp = total + amtinpkr + invlvlchrgs
            //  (banktotal.value * itmratio / 100)
