                    ...
                    <div class="grid">
                        ...
                        <fieldset class="border px-4 py-2 rounded">
                            ...
                            <div class="grid grid-cols-12 gap-1 py-2 items-center">
                                ...
                                <x-input-text title="STO Seq.#" name="stono" id="stono" value="{{$maxstono}}"     required   />
                            </div>
                            <div class="grid grid-cols-12 gap-1 py-2 items-center">
                                <x-input-date title="STO Date" id="stodate" name="stodate" req required class="col-span-2" />
                                <label for="">
...
@push('scripts')
    <script>
        ...
        const deleteIcon = function(cell,formatterParams){return "<i class='fa fa-trash text-red-500'></i>";};
             ...
             const getMaster = @json(route('godownmovement.custplan')) ;
             const getDetails = @json(route('godownmovement.custplandtl'));
        ...
        dynamicTable = new Tabulator("#dynamicTable", {
            ...
            columns:[
                ...
                title:'STOCK QUANTITY', headerHozAlign:"center",
                    columns:[
                {title:"InKg", field:"sqtykg",width:150, cssClass:"bg-gray-200 font-semibold"},
                {title:"InPcs", field:"sqtypcs",width:150, cssClass:"bg-gray-200 font-semibold"},
                {title:"InFeet", field:"sqtyfeet",width:150, cssClass:"bg-gray-200 font-semibold"},
...
//                        return  ( Number(cell.getData().feedqty) * Number(cell.getData().price)).toFixed(0)
        ...
        function validateForm()
        {
            ...
            var data = { 'godownmovement' : dynamicTableData, 'fromg': fromg.value,'tog': tog.value,'stodate':stodate.value,'stono':stono.value,'mremarks':mremarks.value};

            // All Ok - Proceed
            fetch(@json(route('godownmovement.store')),{
