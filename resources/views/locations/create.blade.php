                        ...
                        @csrf
                            <div class="flex flex-row justify-start space-x-6 items-center">
                                <div>
                                    ...
                                    <x-input id="locname" class="block mt-2 bg-slate-200 w-96 " type="locname"  name="locname" :value="old('locname')"  />
                                </div>
                            </div>
                            <div class="mt-4">
                                <div>
                                          <label for="exampleFormControlTextarea1" class="form-label inline-block mb-2 text-gray-700"
                                            >Address</label>
                                          <textarea  class=" form-control block w-full px-3 py-1.5 text-base font-normal  text-gray-700  bg-white bg-clip-padding  border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="locaddress" id="locaddress" rows="2" placeholder=""></textarea>
                                        {{-- </div>
                                      </div> --}}
                                </div>
                            </div>
