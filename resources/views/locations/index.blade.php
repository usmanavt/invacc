                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex flex-col justify-start items-center border rounded-md px-2">
                        <form action="{{ route('locations.store') }}" method="post" >
                            @csrf
                            <p class="font-semibold pb-6">Create New Location</p>
                            ...
                            <x-input id="address" type="text" name="address"  required minlength="3" :value="old('address')"/>
...
<script>
    ...
    const getMaster = @json(route('locations.master'));
    let table;
    let searchValue = "";
    //  Table Filter
