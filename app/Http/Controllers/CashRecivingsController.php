...
class CashRecivingsController extends Controller
{
    public function index()
    {
        return view('cashrecivings.index')
    ...
    public function getMaster(Request $request)
    {
        ...
        //  With Tables
        $contracts = CashTransaction::where('transaction_type','=','CRV')->where(function ($query) use ($search){
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('cashrecivings.index');
        } catch (\Throwable $th) {
            DB::rollback();
            throw $th;
        }
    ...
    {
        // dd($request->all());
        return view('cashrecivings.edit')
    ...
    public function update(Request $request, CashTransaction $bt)
    {
        ...
        try {
            ...
            $bt->save();
            DB::commit();
            Session::flash('info','Cash Receiving/Transaction updated');
            return redirect()->route('cashrecivings.index');
        } catch (\Throwable $th) {
            DB::rollback();
            throw $th;
