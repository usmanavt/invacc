...
class StockanalysisController extends Controller
{
    ...
    public function fetch(Request $request)
    {
        ...
        if($report_type === 'tb'){
            ...
            $html =  view('analysis.trialbalance')->with('data',$data)->with('fromdate',$fromdate)->with('todate',$todate)->render();
            $filename = 'TrialBalance-'.$fromdate.'-'.$todate.'.pdf';
    ...
    if($report_type === 'bs'){
        ...
        $mpdf = $this->getMPDFSettings();
        $html =  view('analysis.balancesheet')->with('data',$data)->with('fromdate',$fromdate)->with('todate',$todate)->render();
        $filename = 'Balancesheet-'.$fromdate.'-'.$todate.'.pdf';
