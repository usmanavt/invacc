...
{
    use HasFactory;
    protected $dates = ['invoice_date','machine_date','gd_date'];
    protected $fillable = [
        'commercial_invoice_id','gdno','gd_date','invoice_date','invoiceno','supplier_id','machine_date','machineno','conversionrate','insurance','bankcharges','collofcustom','exataxoffie','lngnshipdochrgs','localcartage','miscexplunchetc','customsepoy','weighbridge','miscexpenses','agencychrgs','otherchrgs','cleared','status', 'totallccostwexp','clearmade'
    ];
    ...
    /************** Relationships **************/
    public function commericalInvoice(){ return $this->belongsTo(CommercialInvoice::class); }
