...
class CreateClearanceCompletedDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('clearance_completed_details', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('totallccostwexp', 15, 3)->nullable();
            $table->decimal('otherexpenses', 15, 3)->nullable();
    ...
    {
        Schema::dropIfExists('clearance_completed_details');
    }
}
