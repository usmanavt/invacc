...
class CreateClearancePendingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('clearance_pending_details', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('clearance_id');
            ...
            $table->decimal('pcs_pending', 8, 3)->default(00.000);
            $table->decimal('gdswt_pending', 8, 3)->default(00.000);
            $table->decimal('inkg_pending', 8, 3)->default(00.000);
            ...
            $table->decimal('totallccostwexp', 15, 3)->default(00.000);
    ...
    {
        Schema::dropIfExists('clearance_pending_details');
    }
}
